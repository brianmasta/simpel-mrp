    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="d-flex gap-2">
                <button class="btn btn-success" wire:click="simpan"><i class="cil-save"></i> Simpan</button>

                @if($formatId)
                    <button class="btn btn-secondary" wire:click="preview({{ $formatId }})"><i class="cil-zoom"></i> Preview</button>
                @endif
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    <button class="btn btn-sm btn-primary" wire:click="edit({{ $f->id }})"><i class="cil-pencil"></i> Edit</button>
                                    <button class="btn btn-sm btn-danger" wire:click="hapus({{ $f->id }})"><i class="cil-trash"></i> Hapus</button>
                                    <button class="btn btn-sm btn-secondary" wire:click="preview({{ $f->id }})"><i class="cil-zoom"></i> Preview</button>
                                </div>
                            </td>
                        </tr>
                    @empty
