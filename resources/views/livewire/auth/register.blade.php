        ...
        <div class="col-md-6">
          <div class="card mb-4 mx-4">
            <div class="card-body p-4">
              <h1>Register Akun</h1>
              <p class="text-body-secondary">Buat Akun Anda</p>
              ...
              <div class="input-group mb-3"><span class="input-group-text">
                ...
                <input class="form-control" type="text" wire:model="name" placeholder="Nama Lengkap">
                @error('name') <small class="text-danger">{{ $message }}</small> @enderror
              </div>
              {{-- <div class="input-group mb-3"><span class="input-group-text">
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="currentColor"  class="icon icon-tabler icons-tabler-filled icon-tabler-mail"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M22 7.535v9.465a3 3 0 0 1 -2.824 2.995l-.176 .005h-14a3 3 0 0 1 -2.995 -2.824l-.005 -.176v-9.465l9.445 6.297l.116 .066a1 1 0 0 0 .878 0l.116 -.066l9.445 -6.297z" /><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z" /></svg>
                </span>
                <input class="form-control" type="number" wire:model="nik" placeholder="NIK">
              ...
              <div class="input-group mb-4"><span class="input-group-text">
                ...
                <input class="form-control" type="password" wire:model="password_confirmation" placeholder="Konfirmasi Password">
              </div>
